...
export class MenuHorizontalComponent implements OnInit, AfterViewInit {
  ...
  private appSettingService: AppSettingsService
        ...
        route.data.subscribe(event => {
            this.horizonalMenuName = route.snapshot.data.horizonalMenuName;
            if (!this.horizonalMenuName) {
                this.horizonalMenuName = 'default';
            }
        });
    }
	 ...
	 */
    ngOnInit(): void {
        this.rootArrowEnabled = this.appSettingService.getLayoutConfig('header.menu.self.root-arrow');
