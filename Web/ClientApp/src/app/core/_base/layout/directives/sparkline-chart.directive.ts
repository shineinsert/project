...
export class SparklineChartDirective implements AfterViewInit {
	 ...
	 */
    constructor(private el: ElementRef, private appSettingsService: AppSettingsService) {
    }
        ...
        const config = {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    pointHoverBackgroundColor: this.appSettingsService.getLayoutConfig('colors.state.danger'),
